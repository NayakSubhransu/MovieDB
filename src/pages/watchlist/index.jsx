  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center m-8 ">
        <input
          className="bg-slate-200 p-3 enabled:hover:bg-slate-300 transition duration-300 transform hover:scale-110 disabled:opacity-75 w-[20rem] text-black outline-none" // changed text color for better visibility
          type="text"
